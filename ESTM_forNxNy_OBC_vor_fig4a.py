...
list_of_sites_around_mid = [[5, 3, 1], [4, 4, 1], [4, 4, 2], [5, 4, 1], [5, 4, 2], [4, 5, 2]] #each site labelled as [x,y,alpha]
                                                                                               # as in alpha is A or B>> 1 or 2
...
#%%
#plot_Rho_core_sites_against_epsilon(Q: can this be a function?

Epsilon, Rho = Rho_sites_all_epsilons(8, 8, 20, 1, list_of_sites_around_mid )
plt.figure()
plt.plot(Epsilon, Rho, marker="-")
#plt.xlim(-0.4, 0.17)      # x-axis range if want to see full picture please include 0, coz there is a group of epsi_n at 0
#plt.ylim(-2.2, -1)     # y-axis range
plt.xlabel(r'$\epsilon$')
plt.ylabel(r'$\Rho$')
#plt.legend()
plt.title("$\Rho$ against $\epsilon$")
plt.grid()
plt.show()
